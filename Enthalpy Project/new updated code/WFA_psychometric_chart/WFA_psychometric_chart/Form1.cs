...
// now lets plot on graph...
            ...
            chart1.Series["SeriesDBT_HR"].Color = Color.Green;
            chart1.Series["SeriesDBT_HR"].MarkerSize=15;
    ...
    //        MessageBox.Show("X1= " + x1);
      ...
      //      MessageBox.Show("y1= " + y1);
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            double WBT = 0.000000;
            double humidity = 0.000000;
            try
            {
               WBT = Double.Parse(tb_WBT.Text.Trim());
                humidity = Double.Parse(tb_humidity.Text.Trim());
            }
            catch (Exception ex)
            {
                MessageBox.Show(ex.Message);
            ...
            plot_by_WBT_humidity(WBT, humidity);
        ...
        private void chart1_MouseMove(object sender, MouseEventArgs e)
        {
          ...
          //  if (((e.X > chartLocationOnForm.X) && (e.X < chartLocationOnForm.X + chart1.ChartAreas[0].Position.Width)) && ((e.Y > chartLocationOnForm.Y) && (e.Y < chartLocationOnForm.Y + chart1.ChartAreas[0].Position.Height))) { 
            ...
            */
            ...
            //lb_x_cord.Text = x.ToString();
            //lb_y_cord.Text = y.ToString();
            
            //lb_x_cord.Text = (e.X - chart1.Location.X).ToString();
            //lb_y_cord.Text = (e.Y - chart1.Location.Y).ToString();


            //lb_x_cord.Text = (e.X -63).ToString();
            //lb_y_cord.Text = (e.Y-436).ToString();
        ...
        //{
        //    //lets display the tool tips...

        //    tp.RemoveAll();
        //    tp.Show("Dew point temperature", this, new Point(label21.Location.X, label21.Location.Y));

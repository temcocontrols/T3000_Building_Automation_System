...
BEGIN_MESSAGE_MAP(CRegisterMonitorDlg, CDialogEx)
	...
	ON_BN_CLICKED(IDC_BUTTON_MONITOR_SAVE, &CRegisterMonitorDlg::OnBnClickedButton1)
	ON_WM_DESTROY()
END_MESSAGE_MAP()
...
void CRegisterMonitorDlg::OnDestroy()
{
	CDialogEx::OnDestroy();
...
bool CRegisterMonitorDlg::Save_Parameter()
{
	UpdateData(TRUE);
	CString temp_slave_id,temp_reg1,temp_reg2,temp_reg3,temp_reg4,temp_reg5,temp_time;
	GetDlgItemTextW(IDC_EDIT1,temp_slave_id);
	GetDlgItemTextW(IDC_EDIT_REG_MONITOR_TIME_READ,temp_time);

	GetDlgItemTextW(IDC_EDIT_REG1,temp_reg1);
	GetDlgItemTextW(IDC_EDIT_REG2,temp_reg2);
	GetDlgItemTextW(IDC_EDIT_REG3,temp_reg3);
	GetDlgItemTextW(IDC_EDIT_REG4,temp_reg4);
	GetDlgItemTextW(IDC_EDIT_REG5,temp_reg5);


	WritePrivateProfileStringW(_T("RegisterMonitor"),_T("Read Interval Time"),temp_time,Program_ConfigFile_Path);
	WritePrivateProfileStringW(_T("RegisterMonitor"),_T("Read Device ID"),temp_slave_id,Program_ConfigFile_Path);
	WritePrivateProfileStringW(_T("RegisterMonitor"),_T("Register1"),temp_reg1,Program_ConfigFile_Path);
	WritePrivateProfileStringW(_T("RegisterMonitor"),_T("Register2"),temp_reg2,Program_ConfigFile_Path);
	WritePrivateProfileStringW(_T("RegisterMonitor"),_T("Register3"),temp_reg3,Program_ConfigFile_Path);
	WritePrivateProfileStringW(_T("RegisterMonitor"),_T("Register4"),temp_reg4,Program_ConfigFile_Path);
	WritePrivateProfileStringW(_T("RegisterMonitor"),_T("Register5"),temp_reg5,Program_ConfigFile_Path);
...
void CRegisterMonitorDlg::InitParameters()
{
	...
	{
		WritePrivateProfileStringW(_T("RegisterMonitor"),_T("Read Interval Time"),_T("1000"),Program_ConfigFile_Path);
		WritePrivateProfileStringW(_T("RegisterMonitor"),_T("Read Device ID"),_T("255"),Program_ConfigFile_Path);
		WritePrivateProfileStringW(_T("RegisterMonitor"),_T("Register1"),_T("0"),Program_ConfigFile_Path);
		WritePrivateProfileStringW(_T("RegisterMonitor"),_T("Register2"),_T("0"),Program_ConfigFile_Path);
		WritePrivateProfileStringW(_T("RegisterMonitor"),_T("Register3"),_T("0"),Program_ConfigFile_Path);
		WritePrivateProfileStringW(_T("RegisterMonitor"),_T("Register4"),_T("0"),Program_ConfigFile_Path);
		WritePrivateProfileStringW(_T("RegisterMonitor"),_T("Register5"),_T("0"),Program_ConfigFile_Path);
	}
	m_reg_address1 = GetPrivateProfileInt(_T("RegisterMonitor"),_T("Register1"),0,Program_ConfigFile_Path);
	m_reg_address2 = GetPrivateProfileInt(_T("RegisterMonitor"),_T("Register2"),0,Program_ConfigFile_Path);
	m_reg_address3 = GetPrivateProfileInt(_T("RegisterMonitor"),_T("Register3"),0,Program_ConfigFile_Path);
	m_reg_address4 = GetPrivateProfileInt(_T("RegisterMonitor"),_T("Register4"),0,Program_ConfigFile_Path);
	m_reg_address5 = GetPrivateProfileInt(_T("RegisterMonitor"),_T("Register5"),0,Program_ConfigFile_Path);
	read_interval_time =  GetPrivateProfileInt(_T("RegisterMonitor"),_T("Read Interval Time"),1000,Program_ConfigFile_Path);
	m_device_ID = GetPrivateProfileInt(_T("RegisterMonitor"),_T("Read Device ID"),255,Program_ConfigFile_Path);

	CString temp_cs;
	temp_cs.Format(_T("%d"),m_reg_address1);
	m_reg_edit1.SetWindowTextW(temp_cs);
	temp_cs.Format(_T("%d"),m_reg_address2);
	m_reg_edit2.SetWindowTextW(temp_cs);
	temp_cs.Format(_T("%d"),m_reg_address3);
	m_reg_edit3.SetWindowTextW(temp_cs);
	temp_cs.Format(_T("%d"),m_reg_address4);
	m_reg_edit4.SetWindowTextW(temp_cs);
	temp_cs.Format(_T("%d"),m_reg_address5);
	m_reg_edit5.SetWindowTextW(temp_cs);
	temp_cs.Format(_T("%d"),m_device_ID);
	m_device_edit.SetWindowTextW(temp_cs);
	temp_cs.Format(_T("%d"),read_interval_time);
	SetDlgItemTextW(IDC_EDIT_REG_MONITOR_TIME_READ,temp_cs);
...
void CRegisterMonitorDlg::OnBnClickedBtnOpen()
{
	...
	if(!m_port_open)
	{
		if(g_bIs_connected)
		{
			...
			m_combo_reg.EnableWindow(1);
			((CEdit *)GetDlgItem(IDC_EDIT_WRITE))->EnableWindow(TRUE);
			((CButton *)GetDlgItem(IDC_BUTTON_MONITOR_SAVE))->EnableWindow(1);
			SetDlgItemTextW(IDC_BTN_OPEN,_T("Stop"));
			m_port_open = true;
			UpdateData(FALSE);

			CString temp_time;
			GetDlgItemTextW(IDC_EDIT_REG_MONITOR_TIME_READ,temp_time);
			read_interval_time = _wtoi(temp_time);
			if(read_interval_time == 0)
				read_interval_time = 1;
			((CEdit *)GetDlgItem(IDC_EDIT_REG_MONITOR_TIME_READ))->EnableWindow(FALSE);
	...
	else
	{
		...
		m_combo_reg.EnableWindow(0);
		((CEdit *)GetDlgItem(IDC_EDIT_WRITE))->EnableWindow(0);
		((CButton *)GetDlgItem(IDC_BUTTON_MONITOR_SAVE))->EnableWindow(0);
		((CEdit *)GetDlgItem(IDC_EDIT_REG_MONITOR_TIME_READ))->EnableWindow(TRUE);

		SetDlgItemTextW(IDC_BTN_OPEN,_T("Start"));
		m_port_open =false;
		UpdateData(FALSE);
...
DWORD WINAPI CRegisterMonitorDlg::ReadRegAddress(LPVOID lpVoid)
{
	...
	while(1)
	{
		...
		cs_reg_value.Empty();
		cs_reg_value.Format(_T("Reg%-5d = %-5d ,Reg%-5d = %-5d , Reg%-5d = %-5d , Reg%-5d = %-5d , Reg%-5d = %-5d"),
		...
		Sleep(pParent->read_interval_time);
	}
	return 1;
}

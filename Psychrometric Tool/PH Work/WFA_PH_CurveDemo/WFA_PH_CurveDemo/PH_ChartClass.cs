...
namespace WFA_PH_CurveDemo
{
     class PH_ChartClass
    {
        ...
        /// <returns></returns>
        //public double IAPWS_IF97_SingleParameterEquivalentFxn_For_psat(string outputParamName, string prop1)
        //{
        //    double result = 0;//CoolProp.Props1SI(outputParamName, prop1);

        //    return result;
        //}

        //==Let me create a custom mess grid view

...
{
    public partial class Form_HumiditySourceDeviceInput : Form
    {
        EditNodeLineForm f1;
        public Form_HumiditySourceDeviceInput(EditNodeLineForm f)
        {
            f1 = f;
            InitializeComponent();
        }

        private void Form_HumiditySourceDeviceInput_Load(object sender, EventArgs e)
        {
            //--This is where we load the controllers ....
            ...
            if (CB_Device.SelectedIndex > -1)
            {
                ...
                if (CheckDeviceOnlineOffline(deviceInstanceValuTemp, 0) == true)
                {
                    ...
                    */
                    ...
                    CB_param_hum.Enabled = true; //enabling humidity value
       ...
       // List<T3000DataType> FilteredTemperatureValueList = new List<T3000DataType>();
        ...
        {
            //--This is now the selection part
            ...
            */
            ...
            if (CB_param_hum.SelectedIndex > -1)
            {
                ...
                indexForParameter1 = CB_param_hum.SelectedIndex;
            }

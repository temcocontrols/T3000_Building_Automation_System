...
unsigned short read_multi_regvalue[20000]={-1};
...
CString g_strMainDatabasfilepath=_T("");//AddByFance
//CString g_strIniFilePath=_T("");//AddByFance
CString g_CurMainBuilding=_T("");//AddByFance

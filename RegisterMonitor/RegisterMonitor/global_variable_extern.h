...
extern unsigned short read_multi_regvalue[20000];
...
extern CString g_strMainDatabasfilepath;//AddByFance
//extern CString g_strIniFilePath;//AddByFance
extern CString g_CurMainBuilding;//AddByFance

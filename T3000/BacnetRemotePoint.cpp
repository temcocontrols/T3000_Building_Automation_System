...
#define BAC_DO  30
		...
		if (t_type == BAC_OUT)
			temp_type = _T("OUT");
		else if (t_type == BAC_IN)
			temp_type = _T("IN");
		else if (t_type == BAC_VAR)
			temp_type = _T("VAR");
		else if (t_type == COIL_REG)
			temp_type = _T("COIL_REG");
		else if (t_type == DIS_INPUT_REG)
			temp_type = _T("DIS_INPUT_REG");
		else if (t_type == INPUT_REG)
			temp_type = _T("INPUT_REG");
		else if (t_type == MB_REG)
			temp_type = _T("MB_REG");
		else if (t_type == BAC_AV)
			temp_type = _T("AV");
		else if (t_type == BAC_AI)
			temp_type = _T("AI");
		else if (t_type == BAC_AO)
			temp_type = _T("AO");
		else if (t_type == BAC_DO)
			temp_type = _T("DO");
#if 0
		if(dev_reg == 0)
		{

...
extern unsigned int T3000_Version; //T3000�İ汾��.
	...
	case TRANSFER_FILE_PAGE:
		{
			...
			{
				temp_point = temp_point - 3 - 4; //��Ҫ�ع�ͷȥ�õ� �˰��ĳ���;
...
void DownloadSocket::OnConnect(int nErrorCode)
{
	...
	if (!nErrorCode)
	{
		...
		PostMessage(m_parent_hwnd,WM_DOWNLOADFILE_MESSAGE, DOWNLOAD_CONNECT_SUCCESS,NULL); //�����׽���,���ӳɹ�ʱ�Ϳ�ʼ��������ļ�;
		is_connect = true;
	}
	else
	{

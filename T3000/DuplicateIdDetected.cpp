...
void CDuplicateIdDetected::Initial_static()
{
	...
	CString temp_serial_1;
	CString temp_serial_2;
	CString temp_current_id_1;
	CString temp_current_id_2;
	CString temp_user_text_1;
	CString temp_user_text_2;
	CString temp_product_id_1;
	CString temp_product_id_2;

...
BEGIN_MESSAGE_MAP(CImportDatabaseDlg, CDialog)
	...
	ON_BN_CLICKED(ID_CREATE, &CImportDatabaseDlg::OnBnClickedCreate)
END_MESSAGE_MAP()
...
//    }
    ...
    pFile->WriteString(g_strDatabasefilepath);
	pFile->Close();
	EndWaitCursor();
...
void CImportDatabaseDlg::OnClickedBrowsBtn()
{
	...
	g_strDatabasefilepath=strTemp;
	m_sourceDbEditCtrl.SetWindowText(g_strDatabasefilepath);

	//g_strDatabasefilepath=m_strSourceDbFileName;
...
void CImportDatabaseDlg::OnBnClickedCreate()
{

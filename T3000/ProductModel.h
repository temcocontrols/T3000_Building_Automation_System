...
#define PM_TSTAT5i                    8
#define PM_TSTAT8                     9
#define PM_TSTAT10                    10    //带Wifi 的TSTAT 拥有T3 program 的功能 - TSTAT with Wifi has the function of T3 program
...
#define PM_T3PTVG                     49
#define PM_CM5                        50
#define PM_PM5E_ARM                   51   //2019 03 18 由老款5964芯片移植过来 - Ported from the old 5964 chip
#define STM32_PM25                    52
#define PM_T332AI_ARM                 53   //20240115 STM32   32 AI
#define PM_TSTAT9                     59   //2019 06 20 
#define PM_MULTI_SENSOR               60   //等同于 62 ，手持式的 多功能传感器; - Ported from the old 5964 chip
#define PM_TSTAT_AQ                   62   //TSTAT AQ 没有各种控制 输入输出的版本; - Ported from the old 5964 chip
#define PM_ZIGBEE_REPEATER            63   //zigbee的中继器 - Ported from the old 5964 chip
#define PM_TSTAT6_HUM_Chamber         64
#define PM_AIRLAB_ESP32               65   //和Airlab 功能一模一样  带wifi的芯片 - Ported from the old Airlab chip
#define PM_BEENY                      70
...
//产品号是 88   用于最新的 ESP32版本的 T3 BB LB TB Nano - Product number is 88, used for the latest ESP32 version of T3 BB LB TB Nano
#define PM_ESP32_T3_SERIES            88
#define PM_ESP32_T322AI               89
#define PWM_TEMPERATURE_TRANSDUCER    90  //Lijun transudcer 新板子; - Lijun transudcer new board
...
#define PM_FAN_MODULE                 97  //Lijun  ESP32 new board fan  暂时没界面 - Lijun ESP32 new board fan, no interface for now
#define PM_NC                         100
#define PM_TSTAT8_PROGRAM             101  //TSTAT8 的可编程版本; - Programmable version of TSTAT8
...
#define PM_THIRD_PARTY_DEVICE         254      //第三方设备 - Third-party device
#endif

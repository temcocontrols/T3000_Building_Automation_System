 ...
 */
const unsigned int g_versionNO = 20260126;    // PROJECT_VERSION
...
CT3000App::CT3000App()
{
    ...
    // Release 版本编译时间不带这段，这段 只要用在调试时 显示 编译的 带有小数点的版本.
//#ifdef _DEBUG
...
//If there is no T3000 situation
       ...
       if(m_special_customer == 1) //如果是第一类客户，就定义为CPR-1000-Help.chm

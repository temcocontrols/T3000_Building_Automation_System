// T3000LogWindow.cpp : 实现文件; Implementation file
//
...
// CT3000LogWindow 消息处理程序; Message handler
...
{
	// TODO: 在此添加专用代码和/或调用基类; Add specialized code and/or call the base class here

...
LRESULT CBacnetOutput::OutputMessageCallBack_Tstat(WPARAM wParam, LPARAM lParam){
...
void CBacnetOutput::Initial_ListFor_Tstat(){
...
void CBacnetOutput::Initial_Combox_Show_Tstat(){
...
LRESULT CBacnetOutput::Fresh_Output_List_Tstat(WPARAM wParam,LPARAM lParam){
...
//const int TStat_ONOFF_Delay = 9 ;
//const int TStat_Signal_Type = 10 ;
LRESULT CBacnetOutput::Fresh_Output_Item_Tstat(WPARAM wParam,LPARAM lParam)
{
	...
	{	
		...
		pwrite_info->hwnd=m_output_dlg_hwnd;
...
void   CBacnetOutput::Fresh_One_Item(int row){
	if (product_type==CS3000)
	{
		m_output_list.SetItemText(0,TStat_OutputName,m_tstat_output_data.at(0).OutputName.StrValue);
		m_output_list.SetItemText(0,TStat_AM ,m_tstat_output_data.at(0).Signal_Type.StrValue);
...
void CBacnetOutput::OnNMClickListOutput_Tstat(NMHDR *pNMHDR, LRESULT *pResult){

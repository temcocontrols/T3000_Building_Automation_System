// ZigbeeRepeater.cpp : Implementation file
...
// CZigbeeRepeater message handlers
...
void CZigbeeRepeater::Fresh()
{
    ...
    {
        // Zigbee repeater first reads ID then checks if it exists in database, adds if not exist

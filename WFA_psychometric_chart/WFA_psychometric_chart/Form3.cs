            ...
            if (index_for_station_selected > -1)
            {
                ...
                try
                {
                    ...
                    if(InternetAvailable == 2)
                    {
                        ...
                        string logLine = "Error Ended               " + DateTime.Now + "                Internet Connection Available";
                ...
                catch (Exception ex)
                {
                    ...
                    if (!File.Exists(logFile))
                    {
                        ...
                        string logHeader = "Time Status                  Time                            Error Status";
                        string logLine   = "Error Detected               "+DateTime.Now +"                Internet Connection Lost:"+ex.Message;
       ...
       double total_percentage_change = 0;
        ...
        public void update_constantly_function()
        {
            ...
            if (index_for_station_selected > -1)
            {
                ...
                {
                    //MessageBox.Show("pulling...");
                    label30.Text = "Status : Updating data...";

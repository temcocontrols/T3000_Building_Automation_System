...
namespace WFA_psychometric_chart
{
    public partial class InsertNodeFormForBuildingChartSetting : Form
    {
             ...
             if(checkBox1.Checked = true && checkBox2.Checked == true)
                {
                    ...
                    string hum_param_id = parameterValFromBacnet[CB_param_hum.SelectedIndex].indexID.ToString();
                    string hum_present_value = parameterValFromBacnet[CB_param_hum.SelectedIndex].presentValue.ToString();
                    //Lets print this values...
                  //  MessageBox.Show("devins = " + device_instance + ",ip  = " + deviceIP + ",id =" + temp_param_id + ",value =" + temp_present_value + ",humid=" + hum_param_id + "va=" + hum_present_value);

                    //info has to be temp and hum
                    F1.SetNodeForDeviceUsingTempAndHum(source, name, label, btnColor.BackColor, cbItemSelected, 20, device_instance, deviceIP, temp_param_id, hum_param_id, "temp", "hum", temp_present_value, hum_present_value);


                }
             else if(checkBox1.Checked == true && checkBox3.Checked == true)
                {
                    //Temp and enthalpy is selected
                    //now param1 will be temp and param2 will be enthalpy

                }
                else
                {
                    //hum and enthalpy is selected
                ...
                //  F1.SetNode( source, name, label, btnColor.BackColor, cbItemSelected,20);   //20 is the marker size 
                F1.SetNodeForWeb(source, name, label, btnColor.BackColor, cbItemSelected, 20);                                                                     //MessageBox.Show(Properties.Resources.Success0);
            }
            this.Close();
        ...
        private void CB_param_enthalpy_SelectedIndexChanged(object sender, EventArgs e)
        {
            btnSetNode.Enabled = true;

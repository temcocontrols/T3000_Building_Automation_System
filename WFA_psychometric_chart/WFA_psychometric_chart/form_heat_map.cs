    ...
    public partial class form_heat_map : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
           ...
           //     string connString1 = @"Data Source=GREENBIRD;Initial Catalog=db_psychrometric_project;Integrated Security=True";
            ...
            {
                MessageBox.Show(WFA_psychometric_chart.Properties.Resources.Please_select_correct_date_for);
            }
                ...
                for (int i = 0; i < hist_temp_hum_list.Count; i++)
            {
                ...
                MessageBox.Show(WFA_psychometric_chart.Properties.Resources.Success_final);
            }//close of if
            else
            {
                MessageBox.Show(WFA_psychometric_chart.Properties.Resources.No_data_found_in_database);
            }
        ...
        private void saveAsImageToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                MessageBox.Show(WFA_psychometric_chart.Properties.Resources._Your_chart_image_will_be_save +fileName);
            }

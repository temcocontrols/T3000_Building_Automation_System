    ...
    public partial class form_process_diagram : Form
    {
        ...
        private void setDataToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            */
            ...
            {
                MessageBox.Show("Please select a proper region in the chart");
            }
        ...
        public void plot_on_graph_values(double dbt, double hr, double xval, double yval)
        {
            ...
            if (index > 0)
            {
                ...
                string tooltipString = "Sequence : \n" + "     start    end \n" + "Temp : " + menuStripAllValues[index - 1].xVal + "  " + menuStripAllValues[index].xVal + "\n Humidity : ";
        ...
        public void ReDrawLines(double id, double x, double y, Color c)
        {
            ...
            if (incrementIndex > 0)
            {
                ...
                string tooltipString = "Sequence : \n" + "     start    end \n" + "Temp : " + menuStripAllValues[incrementIndex - 1].xVal + "  " + menuStripAllValues[incrementIndex].xVal + "\n Humidity : ";
                newSeries.ToolTip = tooltipString;
                //newSeries.MarkerStyle = MarkerStyle.Circle;
                //newSeries.Points.AddXY(menuStripAllValues[index - 1].xVal, menuStripAllValues[index].xVal, menuStripAllValues[index - 1].yVal, menuStripAllValues[index].yVal);
